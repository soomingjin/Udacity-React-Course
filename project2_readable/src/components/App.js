...
import {getCategories, getAllPosts} from '../actions'
...
class App extends Component {
  ...
  componentWillMount() {
    api.getCategories().then(data => this.props.getCategories(data.categories))
      ...
      <div>
        ...
        <div className='container'>
          ...
          <Switch>
            ...
            <Route exact="exact" path='/404' component={NotFound}/>
            <Route exact="exact" path="/:category" component={Category}/>
            <Route exact="exact" path="/:category/:post_id" component={Post}/>
          </Switch>
        </div>
        <Modal isOpen={postModalOpen} toggle={this.togglePostModal}>
          <ModalBody>
            <AddEditPost/>
          </ModalBody>
        </Modal>
